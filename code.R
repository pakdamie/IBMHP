...
###Each time step is 5 minutes
###Merozoite will die in 6 minutes (3 time step)
...
Burst <- function(Pop){
  ...
  #Bye Bye
Burst <- subset(Infected_RBC,  Infected_RBC$time_infected > & Infected_RBC$dead == "F")
...
b<- ggplot(Pop_All, aes(x= x, y= y,fill=type))+
